    ...
    <x-slot name="header">
        ...
        <div class="text-blue-950 py-4">
            <section class="pt-14 space-y-6">
                ...
                <div class="mt-4">
                    <div class="text-3xl"><span class="text-orange-600 font-medium">Г </span>первая буква имени</div>
                </div>
                <!-- панировочные сухари -->
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                        ...
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Г первая буква имени</span>
                            </div>
                        </li>
                    </ol>
                </nav>
