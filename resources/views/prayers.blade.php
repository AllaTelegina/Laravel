            ...
            <div class="pt-12">
                ...
                <div class="-mt-16 mb-8 px-8 ">
                    ...
                    focus:ring-blue-200 dark:focus:ring-blue-800 dark:border-gray-700 dark:text-gray-400 hover:bg-blue-100 dark:hover:bg-gray-800 gap-3"
                                            ...
                                            <span>олитва святого Иоанна Златоустого, тропари и стихи</span>
                                            <svg data-accordion-icon class="w-3 h-3 rotate-180 shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5 5 1 1 5"/>
                                            </svg>
                                        </button>
                                    ...
                                    <div id="accordion-color-body-33" class="hidden" aria-labelledby="accordion-color-heading-33">
                                        <div class="p-5 border border-t-0 border-gray-200 dark:border-gray-700">
                                            ...
                                            <p class="py-2">Се приступáю к Божéственному Причащéнию.
                                                ...
                                                Содéтелю, да не опали́ши мя приобщéнием:</br>

                                                Огнь бо еси́, недостóйныя попаля́яй.</br>

                                                Но у́бо очи́сти мя от вся́кия сквéрны.</p>
                                            ...
                                            <p class="py-2">Боготворя́щую Кровь ужасни́ся, человéче, зря:
                                                ...
                                                Огнь бо есть, недостóйныя попаля́яй.</p>

                                                Божéственное Тéло и обожáет мя и питáет:</br>

                                                Обожáет дух, ум же питáет стрáнно.</p>
                    ...
                    focus:ring-blue-200 dark:focus:ring-blue-800 dark:border-gray-700 dark:text-gray-400 hover:bg-blue-100 dark:hover:bg-gray-800 gap-3"
                                            ...
                                            <span> Тропарь святому Иоанну Златоустому,  Кондак,глас 6-й, 4-й, 3-й</span>
                                            <svg data-accordion-icon class="w-3 h-3 rotate-180 shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5 5 1 1 5"/>
                                            </svg>
                                        </button>
