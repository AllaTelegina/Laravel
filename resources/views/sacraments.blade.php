        ...
        <div class="text-blue-950 py-12">
            ...
            <div class="flex-1 mt-8">
                <div class="relative h-screen w-full">
                    <img src="{{asset('images/915.jpg')}}" alt="Background Image" class="absolute inset-0 w-full h-full object-cover rounded-xl" />
                </div>
            </div>
        </div>

        <div class="text-blue-950  space-y-4 rounded-xl">
            <div class="container px-10 py-8 flex shadow-xl shadow-gray-300  bg-blue-100 z-0 hover:z-50">
                <p>
            ...
            <div class="pt-12">
                <div class="relative w-full h-96">
                    <img class="absolute h-full w-full object-cover object-center rounded-xl" src="{{asset('images/18.jpg')}}" alt="nature image" />
                ...
                <div class="-mt-16 mb-8 px-8 ">
                    <div class="container mx-auto shadow-xl shadow-gray-300">
                        <div class="py-8 flex justify-center rounded-xl bg-blue-100 shadow-black/5 saturate-200">
                ...
                <div class="rounded-xl z-50 opacity-0 group-hover:opacity-100 transition duration-300 ease-in-out cursor-pointer absolute from-black/80 to-transparent bg-gradient-to-t inset-x-0 -bottom-2 pt-30 text-white flex items-end">
                    <div>
                        <div class="transform-gpu  p-4 space-y-3 text-2xl group-hover:opacity-100 group-hover:translate-y-0 translate-y-4 pb-10 transform transition duration-300 ease-in-out">
                            <div class="font-bold text-center">Календарь Именин</div>
                            <div class="opacity-60 text-lg">
                                При крещении важно
                                <a href="#" class="link-warning link-hover">выбрать имя</a>,
                    ...
                    <div class="container mx-auto shadow-xl shadow-gray-300">
                        <div class="py-8 flex justify-center rounded-xl bg-blue-100 shadow-md shadow-black/5 saturate-200">
                            <div class="my-4 grid gap-6 px-4">
                                <p>Венчание — это святое таинство, через которое мужчина и женщина получают благословение на создание семьи в
                                ...
                                <p>
                                    ...
                                    <p>по вторникам, четвергам (накануне постных дней – среды и пятницы) и в субботу (накануне малой Пасхи – дня воскресного);<br>
            ...
            <div class="overflow-hidden  aspect-video bg-blue-100 cursor-pointer rounded-xl relative group relative w-full h-96">
                <div class="rounded-xl z-50 opacity-0 group-hover:opacity-100 transition duration-300 ease-in-out cursor-pointer absolute from-black/80 to-transparent bg-gradient-to-t inset-x-0 -bottom-2 pt-30 text-white flex items-end">
                    <div>
                        <div class="transform-gpu  p-4 space-y-3 text-2xl group-hover:opacity-100 group-hover:translate-y-0 translate-y-4 pb-10 transform transition duration-300 ease-in-out">
                            <a href="/weddingcalendar" class="font-bold text-center">Календарь Венчаний</a>
                            <div class="opacity-60 text-lg ">
                                ...
                                Поэтому вы можете ознакомиться с нашим <a href="/weddingcalendar" class="link-warning link-hover">календарем венчаний</a>, который доступен на нашем сайте.
            ...
            <div class=" m-6">
                <div class="text-blue-950 text-2xl text-semibold py-12 text-center bg-blue-100 rounded-xl pt-4">
                <p id="consult" >Нужна консультация?</p>
                </div>
                <form action="#">
                    <div class="mb-4 pt-4">
                        <div class="relative w-full min-w-[200px] h-11 !min-w-full">
                            <input type="text" name="Name"
                                   class="peer w-full h-full bg-transparent
                                        text-blue-gray-700 font-sans font-normal outline outline-0 focus:outline-0 disabled:bg-blue-gray-50 disabled:border-0
                                        disabled:cursor-not-allowed transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200
                                        placeholder-shown:border-t-blue-gray-200 border focus:border-2 border-t-transparent focus:border-t-transparent
                                        placeholder:opacity-0 focus:placeholder:opacity-100 text-sm px-3 py-3 rounded-md border-blue-gray-200 focus:border-gray-900" placeholder=" " />
                            <label class="flex w-full h-full select-non pointer-events-none absolute left-0 font-normal !overflow-visible truncate
                                            ...
                                            text-[11px] peer-focus:text-[11px] before:content[&#x27; &#x27;] before:block before:box-border before:w-2.5
                                            ...
                                            after:transition-all peer-disabled:after:border-transparent peer-placeholder-shown:leading-[4.1] text-gray-500
                                            peer-focus:text-gray-900 before:border-blue-gray-200 peer-focus:before:!border-gray-900 after:border-blue-gray-200
                                            peer-focus:after:!border-gray-900">
                                Ваше Имя </label>
                        </div>
                    </div>
                    <div class="mb-4">
                        <div class="relative w-full min-w-[200px] h-11 !min-w-full"><input type="email" name="Email" class="peer w-full h-full bg-transparent
                                        text-blue-gray-700 font-sans font-normal outline outline-0 focus:outline-0 disabled:bg-blue-gray-50 disabled:border-0
                                        disabled:cursor-not-allowed transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200
                                        placeholder-shown:border-t-blue-gray-200 border focus:border-2 border-t-transparent focus:border-t-transparent
                                        placeholder:opacity-0 focus:placeholder:opacity-100 text-sm px-3 py-3 rounded-md border-blue-gray-200 focus:border-gray-900" placeholder=" " />
                            <label class="flex w-full h-full select-non pointer-events-none absolute left-0 font-normal !overflow-visible truncate
                                            ...
                                            after:transition-all peer-disabled:after:border-transparent peer-placeholder-shown:leading-[4.1] text-gray-500
                                            peer-focus:text-gray-900 before:border-blue-gray-200 peer-focus:before:!border-gray-900 after:border-blue-gray-200
                                            peer-focus:after:!border-gray-900">Ваш email </label></div>
                    </div>
                    <div class="mb-4">
                        <div class="relative w-full min-w-[200px] h-11 !min-w-full"><input type="textarea" name="Message" class="peer w-full h-full bg-transparent
                                        text-blue-gray-700 font-sans font-normal outline outline-0 focus:outline-0 disabled:bg-blue-gray-50 disabled:border-0
                                        disabled:cursor-not-allowed transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200
                                        placeholder-shown:border-t-blue-gray-200 border focus:border-2 border-t-transparent focus:border-t-transparent
                                        placeholder:opacity-0 focus:placeholder:opacity-100 text-sm px-3 py-3 rounded-md border-blue-gray-200
                            ...
                            <label class="flex w-full h-full select-none pointer-events-none absolute left-0 font-normal !overflow-visible
                                            ...
                                            peer-placeholder-shown:leading-[4.1] text-gray-500 peer-focus:text-gray-900 before:border-blue-gray-200
                    ...
                    <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
                            ...
                            <p class="block antialiased font-sans text-base leading-relaxed text-inherit font-normal !text-gray-500">Вы соглашаетесь с <a href="#" class="font-medium text-gray-700 hover:text-gray-900">Политикой конфидециальности</a>.</p>
                        </label>
                    </div>

                    <button class="align-middle select-none font-sans font-bold text-center uppercase transition-all disabled:opacity-50
                                    disabled:shadow-none disabled:pointer-events-none text-xs py-3 px-6 rounded-lg
                                    active:shadow-none block w-full mt-6
                        ...
                        motion-safe:hover:scale-110 bg-orange-400 text-white font-medium  rounded hover:bg-blue-950
                         transition duration-700 ease-in-out" type="button">
                        Отправить Батюшке
                    </button>
