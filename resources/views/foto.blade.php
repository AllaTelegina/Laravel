                ...
                <section class="#">
                            ...
                            <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="default-tab" data-tabs-toggle="#default-tab-content" role="tablist">
                                <li class="me-2" role="presentation">
                                    <button class="text-blue-600 border border-white hover:border-blue-600 dark:border-gray-900 dark:bg-gray-900 dark:hover:border-gray-700 bg-white focus:ring-4 focus:outline-none focus:ring-blue-400 rounded-full text-base font-medium px-5 py-2.5 text-center me-3 mb-3 dark:text-white dark:focus:ring-gray-800 tab-button"
                                            id="profile-tab" data-tabs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">Все фотографии</button>
                                </li>
                                <li class="me-2" role="presentation">
                                    <button class="text-blue-600 border border-white hover:border-blue-600 dark:border-gray-900 dark:bg-gray-900 dark:hover:border-gray-700 bg-white focus:ring-4 focus:outline-none focus:ring-blue-400 rounded-full text-base font-medium px-5 py-2.5 text-center me-3 mb-3 dark:text-white dark:focus:ring-gray-800"
                                            id="hram-tab" data-tabs-target="#hram" type="button" role="tab" aria-controls="hram" aria-selected="false">Фотографии Храма князя Владимира</button>
                                </li>
                                <li class="me-2" role="presentation">
                                    <button class="inline-block text-blue-600 border border-white hover:border-blue-600 dark:border-gray-900 dark:bg-gray-900 dark:hover:border-gray-700 bg-white focus:ring-4 focus:outline-none focus:ring-blue-400 rounded-full text-base font-medium px-5 py-2.5 text-center me-3 mb-3 dark:text-white dark:focus:ring-gray-800"
                                            id="chasovnya-tab" data-tabs-target="#chasovnya" type="button" role="tab" aria-controls="chasovnya" aria-selected="false">Фотографии часовни Целительницы</button>
                                </li>
                                <li class="me-2" role="presentation">
                                    <button class="inline-block text-blue-600 border border-white hover:border-blue-600 dark:border-gray-900 dark:bg-gray-900 dark:hover:border-gray-700 bg-white focus:ring-4 focus:outline-none focus:ring-blue-400 rounded-full text-base font-medium px-5 py-2.5 text-center me-3 mb-3 dark:text-white dark:focus:ring-gray-800"
                                            id="school-tab" data-tabs-target="#school" type="button" role="tab" aria-controls="school" aria-selected="false">Фотографии воскресной школы</button>
                                </li>
                            </ul>
                        </div>
                    ...
                    imageGalleryClose() {
                        this.imageGalleryOpened = false;
                            ...
                            <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="hram" role="tabpanel" aria-labelledby="hram-tab">
                                <!-- Фотографии Храма князя Владимира -->
                                <div x-data="{
                    imageGalleryOpened: false,
                    imageGalleryActiveUrl: null,
                    imageGalleryImageIndex: null,
                    ...
                    imageGalleryClose() {
                        this.imageGalleryOpened = false;
                                    ...
                                    <ul x-ref="gallery" id="gallery-hram" class="grid grid-cols-2 gap-5 lg:grid-cols-5">
                                        @foreach($hram as $one)
                                            <li><img x-on:click="imageGalleryOpen" src="{{asset('storage/'.$one->url)}}" class="object-cover select-none w-full h-auto bg-gray-200 cursor-zoom-in aspect-[5/6] lg:aspect-[2/3] xl:aspect-[3/4] rounded-lg" alt="{{$one->name}}"></li>
                                        @endforeach
                                    </ul>
                            ...
                            <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="chasovnya" role="tabpanel" aria-labelledby="chasovnya-tab">
                                <!-- Фотографии часовни Целительницы -->
                                <div x-data="{
                    imageGalleryOpened: false,
                    imageGalleryActiveUrl: null,
                    imageGalleryImageIndex: null,
                    ...
                    imageGalleryClose() {
                        this.imageGalleryOpened = false;
                                    ...
                                    <ul x-ref="gallery" id="gallery-chasovnya" class="grid grid-cols-2 gap-5 lg:grid-cols-5">
                            ...
                            <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="school" role="tabpanel" aria-labelledby="school-tab">
                                <!-- Фотографии воскресной школы -->
                                <div x-data="{
                    imageGalleryOpened: false,
                    imageGalleryActiveUrl: null,
                    imageGalleryImageIndex: null,
                    ...
                    imageGalleryClose() {
                        this.imageGalleryOpened = false;
                                    ...
                                    <ul x-ref="gallery" id="gallery-school" class="grid grid-cols-2 gap-5 lg:grid-cols-5">
